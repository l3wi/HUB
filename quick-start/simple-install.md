...
```sudo apt update```
# IOTA Hub Installation Tutorial
...
- Go straight to testing the Hub by [creating a user](create-user.md)
- Improve the security of your Hub by adding the [signing server](signing-server.md)
